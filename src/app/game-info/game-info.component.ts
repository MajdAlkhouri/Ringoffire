...
export class GameInfoComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(): void {
    if (this.card) { // nur wenn karte bereits existiert
      console.log('description :', this.description);
      console.log('Current nummber is :', +this.card.split('_')[1]); //warum +
      let cardNumber = +this.card.split('_')[1]; // nicht verstanden
